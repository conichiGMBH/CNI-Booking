...
struct CNINetworkConstants {
    static let devBaseURL = "http://dev.app.conichi.com/api/v3/"
    static let stagingBaseURL = "http://staging.app.conichi.com/api/v3/"
    static let productionBaseURL = "http://app.conichi.com/api/v3"
}
